...
!function(e, t) {
  ...
  e.Controller = function(r) {
      function i() {
          var e, t, n;
          S && g && (e = o.type.Array(g) ? g : p.slice(0),
          g = !1,
          t = v,
          0 != (n = (v = d.scrollPos()) - t) && (m = 0 < n ? "FORWARD" : c),
          m === c && e.reverse(),
      ...
      var a, l, c = "REVERSE", f = "PAUSED", u = n.defaults, d = this, h = o.extend({}, u, r), p = [], g = !1, v = 0, m = f, w = !0, y = 0, S = !0, b = function() {
      ...
      this.removeScene = function(e) {
          ...
          )) : -1 < (t = p.indexOf(e)) && (e.off("shift.controller_sort"),
          p.splice(t, 1),
          e.remove()),
          d
      }
      ...
      this.updateScene = function(t, n) {
          ...
          )) : n ? t.update(!0) : !0 !== g && t instanceof e.Scene && (~(g = g || []).indexOf(t) || g.push(t),
          g = L(g),
          s()),
          d
      }
      ...
      this.scrollTo = function(n, r) {
          if (o.type.Number(n))
              ...
              if (i) {
                  for (; i.parentNode.hasAttribute(t); )
                      i = i.parentNode;
      ...
      this.scrollPos = function(e) {
          return arguments.length ? (o.type.Function(e) && (E = e),
          d) : E.call(d)
      }
      ,
      ...
      function() {
          ...
          (w = h.container === window || h.container === document.body || !document.body.contains(h.container)) && (h.container = window),
          y = x(),
          h.container.addEventListener("resize", C),
          h.container.addEventListener("scroll", C);
          var t = parseInt(h.refreshInterval, 10);
          h.refreshInterval = o.type.Number(t) ? t : u.refreshInterval,
          b()
      }(),
      d
  }
  ...
  ,
  e.Scene = function(n) {
      var i, s, a = "BEFORE", l = "DURING", c = "AFTER", f = r.defaults, u = this, d = o.extend({}, f, n), h = a, p = 0, g = {
          start: 0,
          end: 0
      }, v = 0, m = !0, w = {};
      ...
      this.trigger = function(t, n) {
          var r, o, i, s;
          return t && (r = t.trim().split("."),
          o = r[0],
          i = r[1],
          (s = w[o]) && s.forEach((function(t, r) {
      ...
      this.remove = function() {
          var e;
          return s && (s.info("container").removeEventListener("resize", z),
          e = s,
          s = void 0,
          e.removeScene(u),
          u.trigger("remove")),
      ...
      this.update = function(e) {
          var t, n;
          return s && (e ? s.enabled() && m ? (t = s.info("scrollPos"),
          n = 0 < d.duration ? (t - g.start) / (g.end - g.start) : t >= g.start ? 1 : 0,
          u.trigger("update", {
              startPos: g.start,
              endPos: g.end,
              scrollPos: t
          }),
          u.progress(n)) : y && h === l && _(!0) : s.updateScene(u, !1)),
          u
      }
      ,
      ...
      this.progress = function(e) {
          if (arguments.length) {
              var t, n, r, o = !1, i = h, f = s ? s.info("scrollDirection") : "PAUSED", g = d.reverse || p <= e;
              return 0 === d.duration ? (o = p != e,
              h = 0 == (p = e < 1 && g ? 0 : 1) ? a : l) : e < 0 && h !== a && g ? (h = a,
              o = !(p = 0)) : 0 <= e && e < 1 && g ? (p = e,
              h = l,
              o = !0) : 1 <= e && h !== c ? (p = 1,
              h = c,
      ...
      var y, S, b = function() {
          ...
          s && d.triggerElement && (g.start -= s.info("size") * d.triggerHook),
          ...
          if (s && (r || 0 < v)) {
              if (r)
                  if (r.parentNode) {
                      for (var i = s.info(), a = o.get.offset(i.container), l = i.vertical ? "top" : "left"; r.parentNode.hasAttribute(t); )
                          r = r.parentNode;
                      var c = o.get.offset(r);
                      i.isDocument || (a[l] -= s.scrollPos()),
                      n = c[l] - a[l]
                  } else
          ...
          duration: function(e) {
              var t;
              if (o.type.String(e) && e.match(/^(\.|\d)*\d+%$/) && (t = parseFloat(e) / 100,
              e = function() {
      ...
      function O(e) {
          s && y && h === l && !s.info("isDocument") && (e.preventDefault(),
      ...
      this.triggerPosition = function() {
          var e = d.offset;
          return s && (d.triggerElement ? e += v : e += s.info("size") * u.triggerHook()),
          e
      }
      ,
      u.on("shift.internal", (function(e) {
          var t = "duration" === e.reason;
          (h === c && t || h === l && 0 === d.duration) && _(),
          t && P()
      }
      ...
      var _ = function(e) {
          ...
          S.pushFollowers ? 0 < d.duration && (h === c && 0 === parseFloat(o.css(S.spacer, "padding-top")) || h === a && 0 === parseFloat(o.css(S.spacer, "padding-bottom"))) && (i = !0) : r[t.vertical ? "top" : "left"] = d.duration * p,
          o.css(n, r),
          i && P()) : ("fixed" != o.css(n, "position") && (o.css(n, {
              position: "fixed"
          }),
          P()),
          f = o.get.offset(S.spacer, !0),
          u = d.reverse || 0 === d.duration ? t.scrollPos - g.start : Math.round(p * d.duration * 10) / 10,
          f[t.vertical ? "top" : "left"] += u,
          o.css(S.spacer.firstChild, {
              top: f.top,
              left: f.left
          })))
      }
        , P = function() {
          ...
          t = s.info("vertical"),
          n = S.spacer.firstChild,
          r = o.isMarginCollapseType(o.css(S.spacer, "display")),
          i = {},
          S.relSize.width || S.relSize.autoFullWidth ? e ? o.css(y, {
              width: o.get.width(S.spacer)
          }) : o.css(y, {
              width: "100%"
          }) : (i["min-width"] = o.get.width(t ? y : n, !0, !0),
          i.width = e ? i["min-width"] : "auto"),
          S.relSize.height ? e ? o.css(y, {
              height: o.get.height(S.spacer) - (S.pushFollowers ? d.duration : 0)
          }) : o.css(y, {
              height: "100%"
          }) : (i["min-height"] = o.get.height(t ? n : y, !0, !r),
          i.height = e ? i["min-height"] : "auto"),
          S.pushFollowers && (i["padding" + (t ? "Top" : "Left")] = d.duration * p,
          i["padding" + (t ? "Bottom" : "Right")] = d.duration * (1 - p)),
          o.css(S.spacer, i))
      };
      this.setPin = function(e, n) {
          ...
          !s && n.pushFollowers && (n.pushFollowers = !1);
          var c, f = y.parentNode.insertBefore(document.createElement("div"), y), d = o.extend(a, {
              position: s ? "relative" : "absolute",
              boxSizing: "content-box",
              mozBoxSizing: "content-box",
              webkitBoxSizing: "content-box"
          });
          return s || o.extend(d, o.css(y, ["width", "height"])),
          o.css(f, d),
          f.setAttribute(t, ""),
      ...
      this.removePin = function(e) {
          var n, r, i;
          return y && (h === l && _(!0),
          !e && s || ((n = S.spacer.firstChild).hasAttribute(t) && (r = S.spacer.style,
          i = {},
          ...
          o.css(n, i)),
          S.spacer.parentNode.insertBefore(n, S.spacer),
          S.spacer.parentNode.removeChild(S.spacer),
          y.parentNode.hasAttribute(t) || (o.css(y, y.___origStyle),
      ...
      this.setClassToggle = function(e, t) {
          ...
          return 0 !== n.length && o.type.String(t) && (0 < k.length && u.removeClassToggle(),
          D = t,
          k = n,
  ...
  var o = e._util = function(e) {
      ...
      function r(r, o, i, s) {
          if ((o = o === document ? e : o) === e)
              s = !1;
          else if (!u.DomElement(o))
              return 0;
          r = r[0].toUpperCase() + r.substr(1).toLowerCase();
          var a, l = (i ? o["offset" + r] || o["outer" + r] : o["client" + r] || o["inner" + r]) || 0;
          return i && s && (a = n(o),
          l += "Height" === r ? t(a.marginTop) + t(a.marginBottom) : t(a.marginLeft) + t(a.marginRight)),
          l
      }
      function o(e) {
      ...
      }, s = 0, a = ["ms", "moz", "webkit", "o"], l = e.requestAnimationFrame, c = e.cancelAnimationFrame, f = 0; !l && f < 4; ++f)
          l = e[a[f] + "RequestAnimationFrame"],
          c = e[a[f] + "CancelAnimationFrame"] || e[a[f] + "CancelRequestAnimationFrame"];
      l = l || function(t) {
