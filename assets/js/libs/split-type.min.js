!function(t, e) {
  ...
  const w = "\\u0300-\\u036f\\ufe20-\\ufe23"
    ...
    , O = `(?:${[`${E}${b}?`, b, S, x, "[\\ud800-\\udfff]"].join("|")}\n)`
    , W = RegExp(`${C}(?=${C})|${O}${j}`, "g")
    , T = RegExp(`[${["\\u200d", "\\ud800-\\udfff", w, "\\u20d0-\\u20f0", "\\ufe0e\\ufe0f"].join("")}]`);
  function N(t) {
      return T.test(t)
  }
  function D(t, n="") {
      var s;
      return (t = null == (s = t) ? "" : String(s)) && e(t) && !n && N(t) ? function(t) {
  ...
  function F(t) {
      y(t).isWord ? (m(t),
      t.replaceWith(...t.childNodes)) : l(t.children).forEach((t => F(t)))
  }
  let L = t(k, {});
  class P {
      static get data() {
